...
config={
    "trans" : NOAHCARE+"/config/nc_v1/anno/tr_nc.lst",
#    TGP_POP            : "ASN",
    "ExAC_POP"           : "EAS",
    "FLANK_LEN"	       : 2,
    ...
    # current available tag for BGIGaP_rule are:
    # CLIN (all sources)
    # PP   (pre-pregnancy)
    # DEAF
    # AUTISM
...
#    BGIGaP_rule  : "PP",
#    Panel_ID     : "pcmd",
    "Panel_Control" : NOAHCARE+"/db/anno/panelDB/Hcan2_V1.0.HIGHQ.bed.gz",
...
#    GeneTestCode : $BGICGA . '/list_spec/TCD/PP12_TCD.gz',
#    HomoRef_Var  : $BGICGA . '/list_spec/PP_homoRef_Var.list',
}